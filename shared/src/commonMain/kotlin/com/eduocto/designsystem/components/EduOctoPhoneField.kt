...
fun EduOctoPhoneField(
    ...
    OutlinedTextField(
        ...
        label = { Text(label) },
        prefix = { Text(countryCode, color = if (enabled) colors.onSurface else colors.onSurfaceMuted) },
        modifier = modifier,
        singleLine = true,
        enabled = enabled,
        isError = error != null,
...
@Preview
@Composable
private fun EduOctoPhoneFieldPreview() {
    com.eduocto.designsystem.EduOctoTheme {
        EduOctoPhoneField(value = "81234567890", onValueChange = {}, label = "No. HP")
    }
}
