...
fun productSchoolDarkColors() = ProductSchoolColors(
    ...
    onSurfaceMuted = Color(0xFFAEAEB2),
    onSurfaceFaint = Color(0xFF636366),
    surfaceVariant = Color(0xFF2C2C2E),
    onSurfaceVariant = Color(0xFFAEAEB2),
    outline = Color(0xFF38383A),
    outlineSubtle = Color(0xFF2C2C2E),
    inverseSurface = Color(0xFFF7F8FA),
    inverseOnSurface = Color(0xFF0F1722),
    inversePrimary = Color(0xFFB1C7F2),
    scrim = Color(0xFF000000).copy(alpha = 0.55f),
    surfaceGlass = Color(0xFF2C2C2E).copy(alpha = 0.72f),
    glassOutline = Color.White.copy(alpha = 0.08f),
    navigationActive = Color(0xFF34C759),
